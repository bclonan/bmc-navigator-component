// Your Town Finance Brand Theme
// Based on https://loans.yourtownfinance.com/select-amount and https://www.yourtownfinance.com/

export const yourtownfinanceFinanceTheme = {
  name: 'Your Town Finance',
  description: 'Official Your Town Finance brand theme with primary colors and typography',
  
  // Primary brand colors from Your Town Finance CSS variables
  colors: {
    primary: {
...
export default yourtownfinanceFinanceTheme;