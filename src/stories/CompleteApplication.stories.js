export default {
  title: 'eCFR/Implementation Guide/Complete Application',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'A comprehensive guide to implementing a complete application with the ECFRNavigator component, including URL data loading, content rendering, and state management.'
      }
    }
  }
};
