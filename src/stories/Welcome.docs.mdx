...
# Your Town Finance Component Library

Welcome to the comprehensive Vue 3 component library for Your Town Finance's digital experiences. This library provides production-ready components that combine Material Design principles with Your Town Finance's brand identity and financial industry best practices.
...
1. **Your Town Finance Design System** - Brand guidelines, colors, typography
