...
export default {
  title: 'eCFR/Features/FontSizeDemo',
  component: ECFRNavigator,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Interactive demo of the adaptive font sizing feature in the ECFRNavigator component.'
      }
    }
  }
};
...
export const InteractiveFontSizeDemo = {
  render: () => ({
...
// Accessibility Demo
export const AccessibilityFontSizeDemo = {
  render: () => ({
    components: { ECFRNavigator },
    template: `
      <div class="p-4">
