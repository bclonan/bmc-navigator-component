...
export default {
  title: 'Material UI/MSelect',
  component: MSelect,
  parameters: {
    docs: {
      description: {
        component: 'Material Design select component with dropdown functionality, search capabilities, and multiple selection support.'
      }
    }
  },
  argTypes: {
    ...
    data() {
      return {
        ...
        loanTypes: [
          { value: 'personal', text: 'Personal Loan' },
          { value: 'auto', text: 'Auto Loan' },
          { value: 'home', text: 'Home Improvement' },
          { value: 'debt', text: 'Debt Consolidation' }
        ],
        ...
        creditRanges: [
          { value: 'excellent', text: 'Excellent (750+)' },
          { value: 'good', text: 'Good (700-749)' },
          { value: 'fair', text: 'Fair (650-699)' },
          { value: 'poor', text: 'Poor (600-649)' },
