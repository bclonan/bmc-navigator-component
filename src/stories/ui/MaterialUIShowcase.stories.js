...
export default {
  title: 'Material UI/Complete Showcase',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Complete showcase of all Material UI components working together in a real-world dashboard scenario.'
      }
    }
  }
};
  ...
  render: () => ({
    ...
    data() {
      return {
        // Navigation
        navigationItems: [
          { icon: 'fas fa-tachometer-alt', label: 'Dashboard', route: 'dashboard', active: true },
          { icon: 'fas fa-file-alt', label: 'Applications', route: 'applications' },
          { icon: 'fas fa-credit-card', label: 'Payments', route: 'payments' },
          { icon: 'fas fa-users', label: 'Customers', route: 'customers' },
