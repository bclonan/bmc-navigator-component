...
export default {
  title: 'Material UI/Semantic Form Inputs',
  parameters: {
    docs: {
      description: {
        component: 'Comprehensive showcase of all semantic form inputs with wrap/extend functionality for creating cohesive form sections and custom styling.'
      }
    }
  }
};

export const WrapExtendShowcase = {
  render: () => ({
    components: { MTextField, MSelect, MCheckbox, MSlider, MButton, MCard },
    data() {
      return {
        form: {
          personalInfo: {
...
export const FinancialServicesForms = {
  render: () => ({
    components: { MTextField, MSelect, MCheckbox, MSlider, MButton, MCard },
    data() {
      return {
