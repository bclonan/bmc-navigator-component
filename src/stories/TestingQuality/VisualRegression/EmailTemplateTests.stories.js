...
export default {
  title: 'Testing & Quality/Visual Regression/Email & Widget Testing',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Visual regression testing suite for email templates and marketing widgets across different screen sizes and data scenarios.',
      },
    },
  },
};

export const EmailTemplateVisualTests = () => ({
...
export const MarketingWidgetVisualTests = () => ({
  components: { MarketingWidgets },
  setup() {
    const widgetTypes = ref([
      { type: 'calculator', title: 'Loan Calculator', description: 'Interactive payment calculator' },
      { type: 'rates', title: 'Rate Comparison', description: 'Competitive rate table' },
      { type: 'testimonials', title: 'Customer Testimonials', description: 'Rotating testimonial carousel' },
      { type: 'quick-apply', title: 'Quick Apply Form', description: 'Pre-qualification form' },
      { type: 'locator', title: 'Branch Locator', description: 'Find nearby branches' },
      { type: 'education', title: 'Education Center', description: 'Financial education articles' },
      { type: 'mobile-app', title: 'Mobile App Promo', description: 'App download promotion' }
    ]);
...
export const AccessibilityComplianceTests = () => ({
  components: { EmailTemplates, MarketingWidgets },
  setup() {
    const accessibilityChecklist = ref([
      {
        category: 'Color & Contrast',
        checks: [
          { item: 'Text contrast ratio ≥ 4.5:1', status: 'pass' },
          { item: 'Large text contrast ratio ≥ 3:1', status: 'pass' },
          { item: 'Color not sole means of conveying information', status: 'pass' },
          { item: 'Focus indicators visible and high contrast', status: 'pass' }
        ]
      },
      {
        category: 'Keyboard Navigation',
        checks: [
          { item: 'All interactive elements keyboard accessible', status: 'pass' },
          { item: 'Tab order logical and predictable', status: 'pass' },
          { item: 'No keyboard traps', status: 'pass' },
          { item: 'Skip links available for main content', status: 'pass' }
        ]
      },
      {
        category: 'Screen Reader Support',
        checks: [
          { item: 'Semantic HTML structure', status: 'pass' },
          { item: 'Alternative text for images', status: 'pass' },
          { item: 'Proper heading hierarchy', status: 'pass' },
          { item: 'Form labels associated correctly', status: 'pass' }
        ]
      },
      {
        category: 'Email Client Compatibility',
        checks: [
          { item: 'Gmail rendering correct', status: 'pass' },
          { item: 'Outlook 2016+ compatibility', status: 'pass' },
          { item: 'Apple Mail rendering', status: 'pass' },
          { item: 'Mobile email client support', status: 'pass' }
        ]
      }
    ]);

    const testComponents = ref([
      { type: 'email', component: 'approval', title: 'Loan Approval Email' },
      { type: 'email', component: 'payment-reminder', title: 'Payment Reminder Email' },
      { type: 'email', component: 'marketing', title: 'Marketing Email' },
      { type: 'widget', component: 'calculator', title: 'Loan Calculator Widget' },
      { type: 'widget', component: 'quick-apply', title: 'Quick Apply Widget' }
    ]);
