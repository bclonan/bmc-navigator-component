...
export default {
  title: 'Testing & Quality/Accessibility Tests/Component Accessibility',
  parameters: {
    layout: 'padded',
    docs: {
      description: {
  ...
  argTypes: {
    testScenario: {
      control: { type: 'select' },
      options: ['keyboard-navigation', 'screen-reader', 'color-contrast', 'touch-targets'],
      description: 'Focus area for accessibility testing',
      defaultValue: 'keyboard-navigation',
    },
    contrastMode: {
      control: { type: 'select' },
      options: ['normal', 'high-contrast', 'dark-mode'],
      description: 'Test color contrast scenarios',
      defaultValue: 'normal',
    },
  },
};

export const KeyboardNavigationTest = (args) => ({
...
ColorContrastTest.args = {
  testScenario: 'color-contrast',
  contrastMode: 'normal',
};

export const TouchTargetTest = (args) => ({
  components: { MButton, MInput, MTypography, MAlert },
  setup() {
    return { args };
  },
...
TouchTargetTest.args = {
  testScenario: 'touch-targets',
  contrastMode: 'normal',
};