import{M as T}from"./MButton-BLV5TnM3.js";import{M as x}from"./MAlert-DQn7thiI.js";import{M as w}from"./MChip-tZQLCLk1.js";import{M as C,a as S}from"./MToolbar-YnN95sD0.js";import{M as B}from"./MAvatar-CcTfVmuO.js";import{M as A}from"./MBadge-DjbiMmWJ.js";import{M as a}from"./MTypography-DmD30oZU.js";import"./vue.esm-bundler-BOts1VAj.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const N={title:"Your Town Finance/Brand Theme",parameters:{layout:"fullscreen",docs:{description:{component:"Complete Your Town Finance brand theme implementation with authentic colors and typography from https://loans.yourtownfinance.com/select-amount and https://www.yourtownfinance.com/"}}},argTypes:{variant:{control:{type:"select"},options:["primary","secondary","outlined","text"],description:"Button variant style"},size:{control:{type:"select"},options:["small","medium","large"],description:"Button size"},color:{control:{type:"select"},options:["primary","secondary","success","warning","error","info"],description:"Button color theme"},disabled:{control:{type:"boolean"},description:"Disable button interaction"},loading:{control:{type:"boolean"},description:"Show loading state"},fullWidth:{control:{type:"boolean"},description:"Make button full width"},text:{control:{type:"text"},description:"Button text content"}}},n=()=>({components:{MTypography:a},template:`
  ...
  `}),t=()=>({components:{MButton:T,MTypography:a},template:`
    <div class="p-8 space-y-8">
  ...
  `}),r=()=>({components:{MAppBar:S,MToolbar:C,MTypography:a,MButton:T,MAvatar:B,MBadge:A,MAlert:x,MChip:w},data(){return{notifications:3,loanAmount:"$15,000",interestRate:"8.99%",monthlyPayment:"$187"}},template:`
  ...
  `}),o=()=>({components:{MTypography:a},template:`
  ...
  `}),e=()=>({components:{MAlert:x,MChip:w,MAvatar:B,MBadge:A,MTypography:a},template:`
    <div class="p-8 space-y-8">
  ...
  `});var s,i,l;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`() => ({
  components: {
    MTypography
  },
  template: \`
  ...
  \`
})`,...(l=(i=n.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};var p,y,c;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`() => ({
  components: {
    MButton,
    MTypography
  },
  ...
  \`
})`,...(c=(y=t.parameters)==null?void 0:y.docs)==null?void 0:c.source}}};var d,g,v;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`() => ({
  components: {
    MAppBar,
    MToolbar,
    MTypography,
  ...
  \`
})`,...(v=(g=r.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,m,u;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`() => ({
  components: {
    MTypography
  },
  template: \`
  ...
  \`
})`,...(u=(m=o.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var M,b,f;e.parameters={...e.parameters,docs:{...(M=e.parameters)==null?void 0:M.docs,source:{originalSource:`() => ({
  components: {
    MAlert,
    MChip,
    MAvatar,
  ...
  \`
})`,...(f=(b=e.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const $=["BrandColors","BrandButtons","FinancialDashboard","BrandTypography","ComponentShowcase"];export{t as BrandButtons,n as BrandColors,o as BrandTypography,e as ComponentShowcase,r as FinancialDashboard,$ as __namedExportsOrder,N as default};
