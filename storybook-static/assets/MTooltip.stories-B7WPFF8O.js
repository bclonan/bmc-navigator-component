import{M as t}from"./MTooltip-DPWZkmTQ.js";import{M as D,f as I}from"./MInputWithTooltip-C_uRl9oo.js";import{M as s}from"./MButton-BLV5TnM3.js";import{M as p}from"./MTypography-DmD30oZU.js";import"./vue.esm-bundler-BOts1VAj.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./MInput-CcA3fQAp.js";import"./MInputLabel-3mFzc-XJ.js";import"./MFormHelperText-CT2iaShF.js";const V={title:"MUI Components/Feedback/Tooltip & Financial Literacy",component:t,parameters:{docs:{description:{component:"Contextual help tooltips with financial literacy insights to educate users about loan terms, financial concepts, and best practices."}}},argTypes:{content:{control:{type:"text"},description:"Tooltip content text",defaultValue:"This is helpful information about this field."},title:{control:{type:"text"},description:"Tooltip title",defaultValue:"Financial Guidance"},icon:{control:{type:"text"},description:"Icon class (FontAwesome)",defaultValue:"fas fa-info-circle"},placement:{control:{type:"select"},options:["top","bottom","left","right"],description:"Tooltip placement",defaultValue:"top"},financialInsight:{control:{type:"text"},description:"Financial literacy insight",defaultValue:"This tip helps you make better financial decisions."},actionText:{control:{type:"text"},description:"Action button text",defaultValue:"Learn More"},actionUrl:{control:{type:"text"},description:"Action button URL",defaultValue:"https://www.consumerfinance.gov"},maxWidth:{control:{type:"text"},description:"Maximum tooltip width",defaultValue:"300px"},delay:{control:{type:"number"},description:"Show delay in milliseconds",defaultValue:200}}},e=n=>({components:{MTooltip:t,MButton:s},setup(){return{args:n}},template:`
    <div class="p-8 flex justify-center">
      <MTooltip v-bind="args" @action="handleAction">
        <MButton text="Hover for Help" variant="outlined" color="primary" />
      </MTooltip>
    </div>
  `,methods:{handleAction(a){console.log("Tooltip action clicked:",a)}}});e.args={content:"This is a helpful tooltip with financial guidance.",title:"Financial Guidance",icon:"fas fa-info-circle",placement:"top",financialInsight:"Understanding this concept can help you save money on your loan.",actionText:"Learn More",actionUrl:"https://www.consumerfinance.gov",maxWidth:"300px",delay:200};const i=()=>({components:{MTooltip:t,MTypography:p},data(){return{concepts:[{key:"apr",label:"APR",position:"top"},{key:"creditScore",label:"Credit Score",position:"right"},{key:"loanTerm",label:"Loan Term",position:"bottom"},{key:"monthlyPayment",label:"Monthly Payment",position:"left"},{key:"debtToIncome",label:"Debt-to-Income",position:"top"},{key:"loanPurpose",label:"Loan Purpose",position:"bottom"}]}},methods:{getContent(n){return I[n]},handleTooltipAction(n){console.log("Opening financial education resource:",n)}},template:`
    <div class="p-8">
  ...
  `}),l=()=>({components:{MInputWithTooltip:D,MTypography:p},data(){return{formData:{loanAmount:"",annualIncome:"",creditScore:"",loanTerm:"",loanPurpose:"",monthlyPayment:"",existingDebt:""}}},methods:{handleTooltipAction(n){console.log("Financial education action:",n)}},template:`
  ...
  `}),r=()=>({components:{MTooltip:t,MButton:s},template:`
  ...
  `}),c=()=>({components:{MTooltip:t,MTypography:p},data(){return{financialConcepts:[{key:"apr",icon:"fas fa-percentage",name:"APR"},{key:"creditScore",icon:"fas fa-chart-line",name:"Credit Score"},{key:"debtToIncome",icon:"fas fa-balance-scale",name:"Debt-to-Income"},{key:"loanTerm",icon:"fas fa-calendar-alt",name:"Loan Term"},{key:"monthlyPayment",icon:"fas fa-calculator",name:"Monthly Payment"},{key:"loanPurpose",icon:"fas fa-bullseye",name:"Loan Purpose"},{key:"emergencyFund",icon:"fas fa-piggy-bank",name:"Emergency Fund"},{key:"autopay",icon:"fas fa-sync-alt",name:"AutoPay Benefits"},{key:"loanShopping",icon:"fas fa-shopping-cart",name:"Rate Shopping"},{key:"refinancing",icon:"fas fa-redo-alt",name:"Refinancing"},{key:"loanDefault",icon:"fas fa-exclamation-triangle",name:"Default Risks"},{key:"financialPlanning",icon:"fas fa-route",name:"Financial Planning"}]}},methods:{getContent(n){return I[n]},handleAction(n){console.log("Opening:",n)}},template:`
    <div class="p-8">
  ...
  `}),o=n=>({components:{MTooltip:t,MButton:s},setup(){return{args:n}},template:`
  ...
  `,methods:{handleAction(a){console.log("Tooltip action clicked:",a),alert("Opening financial education resource: "+a)}}});o.args={content:"Understanding APR helps you compare loan offers and choose the most cost-effective option for your financial situation.",title:"Annual Percentage Rate (APR)",icon:"fas fa-percentage",placement:"top",financialInsight:"Even a 1% difference in APR can save you thousands of dollars over the life of your loan.",actionText:"Learn More",actionUrl:"https://www.consumerfinance.gov/ask-cfpb/what-is-the-difference-between-a-loans-interest-rate-and-its-apr-en-135/",maxWidth:"350px",delay:200};var d,m,h;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`args => ({
  components: {
    MTooltip,
    MButton
  },
...
})`,...(h=(m=e.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};var u,g,y;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`() => ({
  components: {
    MTooltip,
    MTypography
  },
  ...
  \`
})`,...(y=(g=i.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var f,v,b;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`() => ({
  components: {
    MInputWithTooltip,
    MTypography
  },
  ...
  \`
})`,...(b=(v=l.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var x,T,M;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`() => ({
  components: {
    MTooltip,
    MButton
  },
  ...
  \`
})`,...(M=(T=r.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};var w,k,A;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`() => ({
  components: {
    MTooltip,
    MTypography
  },
  ...
  \`
})`,...(A=(k=c.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var C,P,L;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    MTooltip,
    MButton
  },
...
})`,...(L=(P=o.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};const $=["BasicTooltip","FinancialLiteracyTooltips","LoanApplicationWithTooltips","TooltipPlacements","FinancialConceptsShowcase","Playground"];export{e as BasicTooltip,c as FinancialConceptsShowcase,i as FinancialLiteracyTooltips,l as LoanApplicationWithTooltips,o as Playground,r as TooltipPlacements,$ as __namedExportsOrder,V as default};
