const o={title:"Getting Started/Overview",parameters:{layout:"fullscreen",docs:{description:{component:"Vue 3 Financial UI Library - A comprehensive component system for financial services applications with Material Design principles, advanced data visualization, and responsive layouts."}}}},i=()=>({template:`
...
&lt;/template&gt;</code></pre>
  ...
  `}),e=i.bind({});e.parameters={docs:{source:{code:'View the source code in the "Docs" tab for implementation details.'}}};var n,t,a;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`() => ({
  template: \`
    <div class="overview-container">
      <!-- Hero Section -->
      <section class="hero-section">
...
&lt;/template&gt;</code></pre>
  ...
  \`
})`,...(a=(t=e.parameters)==null?void 0:t.docs)==null?void 0:a.source}}};const s=["ComponentLibrary"];export{e as ComponentLibrary,s as __namedExportsOrder,o as default};
