import{r as n,w as H,c as b}from"./vue.esm-bundler-BOts1VAj.js";import{u as T}from"./ECFRSection-CJFRE6S2.js";import{E as p}from"./ECFRNavigator-D-HAEfL4.js";import"./pinia-C5ekiB_t.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./ECFRBreadcrumb-D9-R7w7A.js";const K={title:"eCFR/Examples/Complete Page Layout",component:p,parameters:{layout:"fullscreen",docs:{description:{component:"A complete page layout example showing how to implement the ECFRNavigator with content rendering in a side-by-side layout, leveraging the Pinia store for state management."}}}},k=[{id:"title-1",type:"title",number:"1",title:"General Provisions",children:[{id:"part-1-1",type:"part",number:"1",title:"Definitions and General Requirements",children:[{id:"section-1-1-1",type:"section",number:"1.1",title:"Purpose and Scope",content:"<p>This document establishes the framework for federal regulations and specifies the procedures for creating, amending, and rescinding federal rules.</p><p>All regulatory agencies must adhere to these provisions when engaging in rulemaking actions under their respective statutory authorities.</p>"},{id:"section-1-1-2",type:"section",number:"1.2",title:"Definitions",content:"<p>For the purposes of this chapter, the following definitions apply:</p><ul><li><strong>Agency</strong>: Any department, independent establishment, commission, administration, authority, board, or bureau of the United States, including corporations owned or controlled by the United States.</li><li><strong>Rule</strong> or <strong>Regulation</strong>: Any agency statement of general or particular applicability and future effect designed to implement, interpret, or prescribe law or policy.</li><li><strong>Rulemaking</strong>: The agency process for formulating, amending, or repealing a rule.</li></ul>"}]},{id:"part-1-2",type:"part",number:"2",title:"Administrative Procedures",children:[{id:"section-1-2-1",type:"section",number:"2.1",title:"Formal Rulemaking",content:"<p>When rules are required by statute to be made on the record after opportunity for an agency hearing, the following procedures apply:</p><ol><li>Notice of the proposed rulemaking shall be published in the Federal Register.</li><li>Interested parties shall be given an opportunity to participate in the rulemaking through submission of written data, views, or arguments.</li><li>The agency shall hold a public hearing where parties may present testimony and evidence.</li><li>The agency shall maintain a complete record of the proceedings.</li></ol>"},{id:"section-1-2-2",type:"section",number:"2.2",title:"Informal Rulemaking",content:"<p>For rules not subject to formal rulemaking requirements, agencies shall:</p><ol><li>Publish a notice of proposed rulemaking in the Federal Register.</li><li>Provide interested persons an opportunity to participate in the rulemaking through submission of written data, views, or arguments.</li><li>Consider all relevant matter presented.</li><li>Incorporate in the rules adopted a concise general statement of their basis and purpose.</li></ol>"}]}]},{id:"title-2",type:"title",number:"2",title:"Administrative Governance",children:[{id:"part-2-1",type:"part",number:"10",title:"Agency Organization",children:[{id:"section-2-1-1",type:"section",number:"10.1",title:"Organizational Structure",content:"<p>Each federal agency shall maintain and publish an organizational structure that:</p><ul><li>Clearly defines reporting relationships and chains of command.</li><li>Identifies key personnel and their responsibilities.</li><li>Outlines major functional areas and programs.</li></ul><p>This information must be updated annually and made available through the agency's official website.</p>"}]}]}],z={"title-1":{publishInfo:{lastUpdated:"2023-11-15",effectiveDate:"2023-12-01",federalRegisterDoc:"FR-2023-15689"},sourceLinks:{xml:"https://example.gov/regulations/title1.xml",pdf:"https://example.gov/regulations/title1.pdf"},status:"current"},"part-1-1":{publishInfo:{lastUpdated:"2023-10-20",effectiveDate:"2023-11-01",federalRegisterDoc:"FR-2023-13456"},sourceLinks:{xml:"https://example.gov/regulations/part1-1.xml",pdf:"https://example.gov/regulations/part1-1.pdf"},status:"current"},"section-1-1-1":{publishInfo:{lastUpdated:"2023-09-15",effectiveDate:"2023-10-01",federalRegisterDoc:"FR-2023-12345"},sourceLinks:{xml:"https://example.gov/regulations/section1-1-1.xml",pdf:"https://example.gov/regulations/section1-1-1.pdf"},status:"current",amendments:[{date:"2023-09-15",reference:"FR-2023-12345",summary:"Updated purpose statement for clarity"},{date:"2022-05-10",reference:"FR-2022-54321",summary:"Initial publication"}]}},c={render:i=>({components:{ECFRNavigator:p},setup(){const t=T(),s=n(""),g=n(""),w=n(""),x=n(""),y=n(""),v=n(null),h=n(!1);n(window.innerWidth);const l=n(window.innerWidth<768),d=n(!1);t.registerMetadataProcessor("publishInfo",e=>e&&e.publishInfo?{label:`Updated: ${e.publishInfo.lastUpdated}`,color:"blue"}:null),t.registerMetadataProcessor("status",e=>{if(e&&e.status){let a="gray";return e.status==="current"&&(a="green"),e.status==="pending"&&(a="yellow"),e.status==="deprecated"&&(a="red"),{label:e.status.toUpperCase(),color:a}}return null});const B=e=>e?e.replace(/section (\d+\.\d+)/gi,(a,r)=>`<a href="#" class="text-blue-600 hover:underline">section ${r}</a>`):"",I=e=>{h.value=!0,setTimeout(()=>{const a=(f,M)=>{for(const o of f){if(o.id===M)return o;if(o.children&&o.children.length){const C=a(o.children,M);if(C)return C}}return null},r=a(k,e);if(r){g.value=r.title,w.value=r.id,x.value=r.type,y.value=r.number,s.value=r.content||"";const f=t.getItemMetadata(e);v.value=f}else g.value="Not Found",s.value="<p>The requested content could not be found.</p>",v.value=null;h.value=!1,d.value=!1},500)};H(()=>t.currentItem,e=>{e&&e.id&&I(e.id)});const j=b(()=>l.value?"100%":"350px"),W=b(()=>l.value?"100%":"calc(100% - 350px)"),A=b(()=>l.value?"flex-col":"flex-row");return{store:t,currentContent:s,currentTitle:g,currentItemId:w,currentItemType:x,currentItemNumber:y,currentItemMetadata:v,isContentLoading:h,isMobile:l,showMobileNav:d,navWidth:j,contentWidth:W,layoutClass:A,formatDate:e=>e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}):"",renderCitationLinks:B,toggleMobileNav(){d.value=!d.value},handleItemSelected(e){I(e.item.id)}}},template:`
    ...
    `,data(){return{sampleData:k,sampleMetadata:z}},mounted(){window.addEventListener("resize",this.handleResize)},beforeUnmount(){window.removeEventListener("resize",this.handleResize)}})},m={render:()=>({components:{ECFRNavigator:p},template:`
      <div class="p-4">
...
&lt;/template&gt;
    ...
    `})},u={render:()=>({components:{ECFRNavigator:p},setup(){const i=T();return i.registerMetadataProcessor("publishInfo",t=>t&&t.publishInfo?{label:`Updated: ${t.publishInfo.lastUpdated}`,color:"blue"}:null),i.registerMetadataProcessor("status",t=>{if(t&&t.status){let s="gray";return t.status==="current"&&(s="green"),t.status==="pending"&&(s="yellow"),t.status==="deprecated"&&(s="red"),{label:t.status.toUpperCase(),color:s}}return null}),{store:i,sampleMetadata:z}},template:`
      <div class="p-4">
            ...
            <pre class="bg-gray-100 p-3 rounded text-sm overflow-auto">
{
  "section-1-1-1": {
    ...
    `})};var R,U,L;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: args => ({
    components: {
      ECFRNavigator
    },
...
}`,...(L=(U=c.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var S,D,N;m.parameters={...m.parameters,docs:{...(S=m.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(N=(D=m.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var F,E,P;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(P=(E=u.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};const Y=["SideBySideLayout","URLLoadingImplementation","AdvancedMetadataUsage"];export{u as AdvancedMetadataUsage,c as SideBySideLayout,m as URLLoadingImplementation,Y as __namedExportsOrder,K as default};
