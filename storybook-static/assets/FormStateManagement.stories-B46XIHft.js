import{r as i}from"./vue.esm-bundler-BOts1VAj.js";import{M as C}from"./MCard-BMaDLVhA.js";import{M as V}from"./MButton-ClHapibe.js";import{M as D}from"./MTextField-OPGGVjaU.js";import{M as E}from"./MSelect-BPYUGOCn.js";import{M as N}from"./MCheckbox-B-c44SKF.js";import{M as P}from"./MSlider-CAxFof3m.js";import{u as q}from"./useFormValidation-FIwfB6Hc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const O={title:"Loan Application/Form State Management",parameters:{docs:{description:{component:"Comprehensive demonstration of form state management utilities including validation, error handling, field interaction patterns, and real-time updates for financial services applications."}}}},n={render:()=>({components:{MCard:C,MButton:V,MTextField:D,MSelect:E,MCheckbox:N,MSlider:P},setup(){const{formData:t,setValidationRules:c,setAsyncValidators:u,validateField:m,validateForm:p,setFieldValue:v,touchField:f,getFieldError:b,hasFieldError:g,isValid:h,hasErrors:x,handleSubmit:F,validators:e,resetForm:y,clearFieldError:w}=q({personal:{firstName:"",lastName:"",email:"",phone:"",ssn:"",age:18},financial:{income:0,creditScore:650},preferences:{contactMethod:"",newsletter:!1}});c({"personal.firstName":[e.required("First name is required"),e.minLength(2,"First name must be at least 2 characters"),e.pattern(/^[A-Za-z\s'-]+$/,"Only letters, spaces, hyphens, and apostrophes allowed")],"personal.lastName":[e.required("Last name is required"),e.minLength(2,"Last name must be at least 2 characters"),e.pattern(/^[A-Za-z\s'-]+$/,"Only letters, spaces, hyphens, and apostrophes allowed")],"personal.email":[e.required("Email is required"),e.email("Please enter a valid email address")],"personal.phone":[e.required("Phone number is required"),e.phone("Please enter a valid phone number")],"personal.ssn":[e.required("SSN is required"),e.ssn("Please enter a valid SSN (XXX-XX-XXXX)")],"personal.age":[e.required("Age is required"),e.minValue(18,"You must be at least 18 years old"),e.maxValue(100,"Please enter a valid age")],"financial.income":[e.required("Income is required"),e.minValue(1e3,"Monthly income must be at least $1,000")],"financial.creditScore":[e.minValue(300,"Credit score must be between 300-850"),e.maxValue(850,"Credit score must be between 300-850")],"preferences.contactMethod":[e.required("Please select a contact method")]}),u({"personal.email":async a=>a?(await new Promise(r=>setTimeout(r,500)),a.includes("blocked@")?"This email domain is not allowed":!0):!0,"personal.ssn":async a=>a?(await new Promise(r=>setTimeout(r,300)),a==="123-45-6789"?"This SSN is invalid":!0):!0});const S=i(!1),l=i(null);return{formData:t,setFieldValue:v,touchField:f,getFieldError:b,hasFieldError:g,isValid:h,hasErrors:x,validateField:m,validateForm:p,resetForm:y,clearFieldError:w,isSubmitting:S,submitResult:l,async handleFormSubmit(){const a=await F(async r=>(await new Promise(M=>setTimeout(M,2e3)),{id:"APP-"+Date.now(),status:"submitted"}));return l.value=a,a}}},data(){return{contactMethods:[{value:"email",text:"Email"},{value:"phone",text:"Phone"},{value:"mail",text:"Mail"}]}},methods:{formatCurrency(t){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:0}).format(t)}},template:`
    ...
    `}),parameters:{docs:{description:{story:"Comprehensive form state management demonstration showing validation patterns, error handling, async validation, conditional logic, and real-time updates commonly used in financial services applications."}}}};var s,o,d;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => ({
    components: {
      MCard,
      MButton,
    ...
    setup() {
      ...
      setValidationRules({
        'personal.firstName': [validators.required('First name is required'), validators.minLength(2, 'First name must be at least 2 characters'), validators.pattern(/^[A-Za-z\\s'-]+$/, 'Only letters, spaces, hyphens, and apostrophes allowed')],
        'personal.lastName': [validators.required('Last name is required'), validators.minLength(2, 'Last name must be at least 2 characters'), validators.pattern(/^[A-Za-z\\s'-]+$/, 'Only letters, spaces, hyphens, and apostrophes allowed')],
        'personal.email': [validators.required('Email is required'), validators.email('Please enter a valid email address')],
        'personal.phone': [validators.required('Phone number is required'), validators.phone('Please enter a valid phone number')],
        'personal.ssn': [validators.required('SSN is required'), validators.ssn('Please enter a valid SSN (XXX-XX-XXXX)')],
        'personal.age': [validators.required('Age is required'), validators.minValue(18, 'You must be at least 18 years old'), validators.maxValue(100, 'Please enter a valid age')],
        'financial.income': [validators.required('Income is required'), validators.minValue(1000, 'Monthly income must be at least $1,000')],
        'financial.creditScore': [validators.minValue(300, 'Credit score must be between 300-850'), validators.maxValue(850, 'Credit score must be between 300-850')],
        'preferences.contactMethod': [validators.required('Please select a contact method')]
      });
...
}`,...(d=(o=n.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const B=["ValidationPatterns"];export{n as ValidationPatterns,B as __namedExportsOrder,O as default};
