import{E as e}from"./ECFRNavigator-D-HAEfL4.js";import"./ECFRSection-CJFRE6S2.js";import"./pinia-C5ekiB_t.js";import"./vue.esm-bundler-BOts1VAj.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./ECFRBreadcrumb-D9-R7w7A.js";const N={title:"eCFR/Features/URL Data Loading",component:e,parameters:{layout:"fullscreen",docs:{description:{component:"Demonstration of loading data from URLs for more efficient handling of large JSON documents."}}}},x=[{id:"local-item-1",type:"title",number:"1",title:"Local Data Example",children:[{id:"local-part-1",type:"part",number:"100",title:"This data is provided directly through props",children:[]}]}],t={render:()=>({components:{ECFRNavigator:e},template:`
      <div class="p-4">
...
/&gt;
    ...
    `,data(){return{items:x}}})},a={render:()=>({components:{ECFRNavigator:e},template:`
      <div class="p-4">
    ...
    `,data(){return{items:[],simulatedUrl:null,isLoading:!1,hasError:!1,options:{showBreadcrumb:!0,theme:"light",display:{viewMode:"standard"}},sampleData:[{id:"simulated-item-1",type:"title",number:"1",title:"Simulated URL Data",children:[{id:"simulated-part-1",type:"part",number:"100",title:"This data was loaded from a simulated URL",children:[{id:"simulated-section-1",type:"section",number:"100.1",title:"First section from URL",children:[]},{id:"simulated-section-2",type:"section",number:"100.2",title:"Second section from URL",children:[]}]},{id:"simulated-part-2",type:"part",number:"200",title:"Another part from the URL",children:[]}]}]}},methods:{simulateLoading(){this.items=[],this.hasError=!1,this.isLoading=!0,this.simulatedUrl="https://example.com/fake-data-url.json",setTimeout(()=>{this.isLoading=!1,this.items=this.sampleData,this.simulatedUrl=null},2e3)},simulateError(){this.items=[],this.hasError=!0,this.isLoading=!0,this.simulatedUrl="https://example.com/nonexistent-file.json",setTimeout(()=>{this.isLoading=!1,this.simulatedUrl=null},2e3)}}})},s={render:()=>({components:{ECFRNavigator:e},template:`
      <div class="p-4">
...
&lt;ECFRNavigator :dataUrls="urls" /&gt;
    ...
    `})},n={render:()=>({components:{ECFRNavigator:e},template:`
      <div class="p-4">
...
/&gt;
    ...
    `})},i={render:()=>({components:{ECFRNavigator:e},template:`
      <div class="p-4">
...
}`,...(l=(o=t.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var d,m,c;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(c=(m=a.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};var p,g,u;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(u=(g=s.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var h,b,f;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(f=(b=n.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var v,y,L;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    components: {
      ECFRNavigator
    },
...
}`,...(L=(y=i.parameters)==null?void 0:y.docs)==null?void 0:L.source}}};const k=["BasicUsage","SimulatedURLLoading","MultipleURLs","MetadataLoading","PerformanceConsiderations"];export{t as BasicUsage,n as MetadataLoading,s as MultipleURLs,i as PerformanceConsiderations,a as SimulatedURLLoading,k as __namedExportsOrder,N as default};
