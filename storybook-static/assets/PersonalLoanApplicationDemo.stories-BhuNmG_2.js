import{r as _,c as r,a as B}from"./vue.esm-bundler-BOts1VAj.js";import{S as L}from"./StateTransitionVisualizer-Bliu1iFB.js";import{D as $,a as W,u as J}from"./DynamicFormRenderer-Cb9fD5WO.js";import{M}from"./MSlider-CAxFof3m.js";import{p as X,l as Y}from"./formConfigs-3Jm4puB3.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./MCard-BMaDLVhA.js";import"./MButton-ClHapibe.js";import"./MTextField-OPGGVjaU.js";import"./MSelect-BPYUGOCn.js";import"./MCheckbox-B-c44SKF.js";const be={title:"Demo/Personal Loan Application",component:$,parameters:{layout:"fullscreen",docs:{description:{component:"Complete personal loan application with mobile-responsive design, slider controls, and comprehensive validation patterns."}}}},Z=()=>({components:{StateTransitionVisualizer:L,DynamicFormRenderer:$,MSlider:M},setup(){const i=X,u=Y,{formData:t,errors:p,isFormValid:v,validateField:P,validateForm:R,submitForm:q,resetForm:ne,exportForm:te,importForm:ae}=W({autoSave:!0,storageKey:"personal-loan-application"}),j=J({storageType:"localStorage",autoSave:!0}),l=_(1),f=r(()=>i.sections.length),h=r(()=>{const e=t.loanAmount||15e3,a=t.loanTerm||36,s=t.monthlyIncome||5e3,x=t.monthlyExpenses||3e3,o=t.creditScore||720,y=t.debtToIncome||25,g=.085/12;let m=0;{const O=e*g*Math.pow(1+g,a),U=Math.pow(1+g,a)-1;m=O/U}const w=m*a-e,N=e+w,G=s-x,Q=m/s*100;let n=0;o>=750?n+=40:o>=650?n+=30:o>=500?n+=20:n+=10,s>=8e3?n+=30:s>=5e3?n+=25:s>=3e3?n+=15:n+=5,y<=20?n+=30:y<=35?n+=20:y<=45?n+=10:n+=0;const H=Math.min(n,100);return{monthlyPayment:m,totalInterest:w,totalAmount:N,availableIncome:G,paymentToIncomeRatio:Q,approvalLikelihood:H,creditRating:o>=750?"Excellent":o>=650?"Good":o>=500?"Fair":"Poor"}}),z=()=>{l.value<f.value&&l.value++},C=()=>{l.value>1&&l.value--},E=e=>{e>=1&&e<=f.value&&(l.value=e)},b=r(()=>i.sections.find(e=>e.step===l.value)),S=r(()=>b.value?b.value.fields.every(e=>{if(!e.required)return!0;const a=t[e.id];return a!=null&&a!==""}):!1),V=async()=>{if(await R())try{const a=await q(async s=>(await new Promise(x=>setTimeout(x,2e3)),{id:`LOAN-${Date.now()}`,status:"submitted",approvalLikelihood:h.value.approvalLikelihood,estimatedDecision:"2-3 business days",referenceNumber:`REF-${Math.random().toString(36).substr(2,9).toUpperCase()}`}));console.log("Application submitted:",a)}catch(a){console.error("Submission failed:",a)}},K=r(()=>u.states.map(e=>({...e,active:e.step===l.value,completed:e.step<l.value,valid:e.step<=l.value?S.value:!1})));return{formSchema:i,formData:t,errors:p,isFormValid:v,currentStep:l,totalSteps:f,calculations:h,nextStep:z,prevStep:C,goToStep:E,currentSection:b,isCurrentStepValid:S,handleSubmit:V,visualizerStates:K,validateField:P,storage:j}},template:`
  ...
  `}),d=Z.bind({});d.storyName="Complete Application Flow";const ee=()=>({components:{StateTransitionVisualizer:L,MSlider:M},setup(){const i=B({loanAmount:15e3,monthlyIncome:5e3,monthlyExpenses:3e3,creditScore:720}),u=r(()=>{const t=i.loanAmount*.03,p=i.monthlyIncome-i.monthlyExpenses,v=t/i.monthlyIncome*100;return{monthlyPayment:t,availableIncome:p,paymentRatio:v}});return{formData:i,calculations:u}},template:`
  ...
  `}),c=ee.bind({});c.parameters={viewport:{defaultViewport:"mobile1"}};var k,F,I;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`() => ({
  components: {
    StateTransitionVisualizer,
    DynamicFormRenderer,
    MSlider
  ...
  setup() {
    ...
    const calculations = computed(() => {
      ...
      if (creditScore >= 750) approvalScore += 40;else if (creditScore >= 650) approvalScore += 30;else if (creditScore >= 500) approvalScore += 20;else approvalScore += 10;

      // Income stability (30%)
      if (monthlyIncome >= 8000) approvalScore += 30;else if (monthlyIncome >= 5000) approvalScore += 25;else if (monthlyIncome >= 3000) approvalScore += 15;else approvalScore += 5;

      // Debt-to-income ratio (30%)
      if (debtToIncome <= 20) approvalScore += 30;else if (debtToIncome <= 35) approvalScore += 20;else if (debtToIncome <= 45) approvalScore += 10;else approvalScore += 0;
      ...
      return {
        ...
        approvalLikelihood,
        creditRating: creditScore >= 750 ? 'Excellent' : creditScore >= 650 ? 'Good' : creditScore >= 500 ? 'Fair' : 'Poor'
      };
    });
  ...
  \`
})`,...(I=(F=d.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var T,A,D;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`() => ({
  components: {
    StateTransitionVisualizer,
    MSlider
  },
  ...
  \`
})`,...(D=(A=c.parameters)==null?void 0:A.docs)==null?void 0:D.source}}};const xe=["PersonalLoanApplication","MobileQuickCheck"];export{c as MobileQuickCheck,d as PersonalLoanApplication,xe as __namedExportsOrder,be as default};
