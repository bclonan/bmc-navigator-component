import{M as r}from"./MButton-BLV5TnM3.js";import{M as f}from"./MInput-CcA3fQAp.js";import{M as x}from"./MTooltip-DPWZkmTQ.js";import{M as o}from"./MAlert-DQn7thiI.js";import{M as s}from"./MTypography-DmD30oZU.js";import"./vue.esm-bundler-BOts1VAj.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const C={title:"Design System/Accessibility Testing",parameters:{layout:"padded",docs:{description:{component:"Comprehensive accessibility testing scenarios for Your Town Finance components. Use the A11y addon to validate WCAG 2.1 AA compliance across all interactive elements."},canvas:{sourceState:"shown"}},a11y:{config:{rules:[{id:"color-contrast",enabled:!0},{id:"button-name",enabled:!0},{id:"heading-order",enabled:!0},{id:"landmark-one-main",enabled:!0},{id:"region",enabled:!0},{id:"aria-tooltip-name",enabled:!0},{id:"form-field-multiple-labels",enabled:!0},{id:"focus-order-semantics",enabled:!0},{id:"keyboard",enabled:!0}]}},backgrounds:{default:"yourtownfinance-light",values:[{name:"yourtownfinance-light",value:"#ffffff"},{name:"high-contrast",value:"#000000"},{name:"medium-contrast",value:"#666666"}]}},argTypes:{theme:{control:{type:"select"},options:["yourtownfinance","high-contrast","default"],description:"Test different themes for accessibility compliance",defaultValue:"yourtownfinance"},fontSize:{control:{type:"range",min:12,max:24,step:2},description:"Test font size accessibility (zoom simulation)",defaultValue:16},testMode:{control:{type:"select"},options:["keyboard-only","screen-reader","motor-impaired","all"],description:"Accessibility testing mode focus",defaultValue:"all"}}},n=e=>({components:{MButton:r,MInput:f,MTooltip:x,MAlert:o,MTypography:s},setup(){return{args:e}},template:`
  ...
  `});n.args={theme:"yourtownfinance",fontSize:16,testMode:"keyboard-only"};const t=e=>({components:{MButton:r,MTypography:s,MAlert:o},setup(){return{args:e}},template:`
    <div :style="{ fontSize: args.fontSize + 'px' }" class="space-y-6">
      <MTypography variant="h2" component="h1">
  ...
  `});t.args={theme:"yourtownfinance",fontSize:16,testMode:"all"};const a=e=>({components:{MButton:r,MInput:f,MTypography:s,MAlert:o,MTooltip:x},setup(){return{args:e}},template:`
  ...
  `});a.args={theme:"yourtownfinance",fontSize:16,testMode:"screen-reader"};const i=e=>({components:{MButton:r,MTypography:s,MAlert:o},setup(){return{args:e}},template:`
    <div :style="{ fontSize: args.fontSize + 'px' }" class="space-y-6">
      <MTypography variant="h2" component="h1">
  ...
  `});i.args={theme:"yourtownfinance",fontSize:18,testMode:"motor-impaired"};var l,c,d;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`args => ({
  components: {
    MButton,
    MInput,
    MTooltip,
  ...
  \`
})`,...(d=(c=n.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};var p,y,m;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`args => ({
  components: {
    MButton,
    MTypography,
    MAlert
  ...
  \`
})`,...(m=(y=t.parameters)==null?void 0:y.docs)==null?void 0:m.source}}};var u,v,g;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`args => ({
  components: {
    MButton,
    MInput,
    MTypography,
  ...
  \`
})`,...(g=(v=a.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var h,b,M;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`args => ({
  components: {
    MButton,
    MTypography,
    MAlert
  ...
  \`
})`,...(M=(b=i.parameters)==null?void 0:b.docs)==null?void 0:M.source}}};const k=["KeyboardNavigation","ColorContrastTest","ScreenReaderTest","MotorImpairmentTest"];export{t as ColorContrastTest,n as KeyboardNavigation,i as MotorImpairmentTest,a as ScreenReaderTest,k as __namedExportsOrder,C as default};
