import{r}from"./vue.esm-bundler-BOts1VAj.js";import{M as y}from"./MThemeGenerator-DKxcPvbC.js";import{M as p}from"./MButton-ClHapibe.js";import{M as h}from"./MCard-BMaDLVhA.js";import{M as u}from"./MSlider-CAxFof3m.js";import{M as v}from"./MTable-B8rROLud.js";import{M as b}from"./MChart-C1yH-mUs.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const L={title:"Tools/Theming/Theme Showcase",parameters:{layout:"fullscreen",docs:{description:{component:"Comprehensive showcase demonstrating how the theme generator affects all components in real-time financial application scenarios."}}}},a={render:()=>({components:{MThemeGenerator:y,MButton:p,MCard:h,MSlider:u,MTable:v,MChart:b},setup(){const e=r({colors:{primary:"#2563eb",secondary:"#0891b2",success:"#16a34a",warning:"#ea580c",danger:"#dc2626",background:"#ffffff"},typography:{fontFamily:"Inter, system-ui, sans-serif",fontSize:16,lineHeight:1.5,letterSpacing:0},spacing:{base:4,borderRadius:8,padding:16}}),n=r(35e3),t=r(75e3),g=r(!1);return{currentTheme:e,loanAmount:n,monthlyIncome:t,showGenerator:g,loanApplications:[{id:"LA-2024-001",applicant:"Sarah Johnson",amount:25e3,purpose:"Home Improvement",status:"Under Review",submitted:"2024-01-15",creditScore:742},{id:"LA-2024-002",applicant:"Michael Chen",amount:45e3,purpose:"Debt Consolidation",status:"Approved",submitted:"2024-01-14",creditScore:785},{id:"LA-2024-003",applicant:"Emma Davis",amount:15e3,purpose:"Medical Expenses",status:"Pending Documents",submitted:"2024-01-13",creditScore:698}],tableColumns:[{key:"id",label:"Application ID",sortable:!0},{key:"applicant",label:"Applicant",sortable:!0},{key:"amount",label:"Amount",type:"currency",sortable:!0},{key:"purpose",label:"Purpose",sortable:!0},{key:"status",label:"Status",type:"status"},{key:"creditScore",label:"Credit Score",sortable:!0}],chartData:[{x:"Jan",y:2400},{x:"Feb",y:1800},{x:"Mar",y:3200},{x:"Apr",y:2900},{x:"May",y:3800},{x:"Jun",y:4200}]}},computed:{themeVariables(){return{"--theme-primary":this.currentTheme.colors.primary,"--theme-secondary":this.currentTheme.colors.secondary,"--theme-success":this.currentTheme.colors.success,"--theme-warning":this.currentTheme.colors.warning,"--theme-danger":this.currentTheme.colors.danger,"--theme-background":this.currentTheme.colors.background,"--theme-font-family":this.currentTheme.typography.fontFamily,"--theme-font-size":`${this.currentTheme.typography.fontSize}px`,"--theme-line-height":this.currentTheme.typography.lineHeight,"--theme-letter-spacing":`${this.currentTheme.typography.letterSpacing}em`,"--theme-border-radius":`${this.currentTheme.spacing.borderRadius}px`,"--theme-padding":`${this.currentTheme.spacing.padding}px`}},monthlyPayment(){const e=this.loanAmount,n=.089/12,t=60;return Math.round(e*n*Math.pow(1+n,t)/(Math.pow(1+n,t)-1))},approvalLikelihood(){const e=this.monthlyPayment*12/this.monthlyIncome;return e<.28?{score:95,status:"Excellent"}:e<.36?{score:80,status:"Good"}:e<.43?{score:65,status:"Fair"}:{score:40,status:"Poor"}}},template:`
    ...
    `,methods:{onThemeChanged(e){this.currentTheme={...this.currentTheme,...e}},handleTableAction(e,n){console.log("Table action:",e,"Row:",n)}}})},o={render:()=>({components:{MButton:p,MCard:h,MSlider:u},data(){return{themes:[{name:"Default",description:"Clean and modern design",colors:{primary:"#3b82f6",success:"#10b981",background:"#ffffff",secondary:"#6b7280"},spacing:{borderRadius:8,padding:16}},{name:"Financial Pro",description:"Professional financial services",colors:{primary:"#1e40af",success:"#059669",background:"#f8fafc",secondary:"#374151"},spacing:{borderRadius:6,padding:20}},{name:"Dark Mode",description:"Elegant dark interface",colors:{primary:"#3b82f6",success:"#10b981",background:"#111827",secondary:"#6b7280"},spacing:{borderRadius:12,padding:18}},{name:"Minimal",description:"Simple and clean",colors:{primary:"#000000",success:"#28a745",background:"#ffffff",secondary:"#666666"},spacing:{borderRadius:0,padding:12}}],sliderValue:25e3}},template:`
    ...
    `})};var i,s,l;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => ({
    components: {
      MThemeGenerator,
      MButton,
...
}`,...(l=(s=a.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};var d,m,c;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => ({
    components: {
      MButton,
      MCard,
...
}`,...(c=(m=o.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};const $=["FinancialDashboard","ThemeComparison"];export{a as FinancialDashboard,o as ThemeComparison,$ as __namedExportsOrder,L as default};
